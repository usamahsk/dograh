...
const FALLBACK_WORKFLOW_CONFIGURATIONS: WorkflowConfigurations = {
    ...
    vad_stop_secs: 0.2,  // 200 ms VAD silence window (matches backend default)
    user_speech_timeout: 0.3,  // 300 ms confirmation window — faster than the 0.6s pipecat default
    dictionary: '',
