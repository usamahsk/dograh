 ...
 */
export const deleteAzureBlobStorageApiV1OrganizationsStorageAzureBlobDelete = <ThrowOnError extends boolean = false>(options?: Options<DeleteAzureBlobStorageApiV1OrganizationsStorageAzureBlobDeleteData, ThrowOnError>): RequestResult<DeleteAzureBlobStorageApiV1OrganizationsStorageAzureBlobDeleteResponses, DeleteAzureBlobStorageApiV1OrganizationsStorageAzureBlobDeleteErrors, ThrowOnError> => (options?.client ?? client).delete<DeleteAzureBlobStorageApiV1OrganizationsStorageAzureBlobDeleteResponses, DeleteAzureBlobStorageApiV1OrganizationsStorageAzureBlobDeleteErrors, ThrowOnError>({ url: '/api/v1/organizations/storage/azure-blob', ...options });
 ...
 */
export const getAzureBlobStorageApiV1OrganizationsStorageAzureBlobGet = <ThrowOnError extends boolean = false>(options?: Options<GetAzureBlobStorageApiV1OrganizationsStorageAzureBlobGetData, ThrowOnError>): RequestResult<GetAzureBlobStorageApiV1OrganizationsStorageAzureBlobGetResponses, GetAzureBlobStorageApiV1OrganizationsStorageAzureBlobGetErrors, ThrowOnError> => (options?.client ?? client).get<GetAzureBlobStorageApiV1OrganizationsStorageAzureBlobGetResponses, GetAzureBlobStorageApiV1OrganizationsStorageAzureBlobGetErrors, ThrowOnError>({ url: '/api/v1/organizations/storage/azure-blob', ...options });
 ...
 */
export const saveAzureBlobStorageApiV1OrganizationsStorageAzureBlobPost = <ThrowOnError extends boolean = false>(options: Options<SaveAzureBlobStorageApiV1OrganizationsStorageAzureBlobPostData, ThrowOnError>): RequestResult<SaveAzureBlobStorageApiV1OrganizationsStorageAzureBlobPostResponses, SaveAzureBlobStorageApiV1OrganizationsStorageAzureBlobPostErrors, ThrowOnError> => (options.client ?? client).post<SaveAzureBlobStorageApiV1OrganizationsStorageAzureBlobPostResponses, SaveAzureBlobStorageApiV1OrganizationsStorageAzureBlobPostErrors, ThrowOnError>({
 ...
 */
export const testAzureBlobStorageApiV1OrganizationsStorageAzureBlobTestPost = <ThrowOnError extends boolean = false>(options: Options<TestAzureBlobStorageApiV1OrganizationsStorageAzureBlobTestPostData, ThrowOnError>): RequestResult<TestAzureBlobStorageApiV1OrganizationsStorageAzureBlobTestPostResponses, TestAzureBlobStorageApiV1OrganizationsStorageAzureBlobTestPostErrors, ThrowOnError> => (options.client ?? client).post<TestAzureBlobStorageApiV1OrganizationsStorageAzureBlobTestPostResponses, TestAzureBlobStorageApiV1OrganizationsStorageAzureBlobTestPostErrors, ThrowOnError>({
