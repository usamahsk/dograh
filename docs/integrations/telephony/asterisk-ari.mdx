...
Asterisk dials a channel technology and a route, not a number. Dograh builds that dial string from the **Dial String Template** on your configuration, replacing `{number}` with the number being called.
